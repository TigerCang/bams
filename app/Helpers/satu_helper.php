...
if (!function_exists('labelBadge')) {
    function labelBadge($asal, $nomor)
    {
        if ($asal == 'barangpo') {
            ...
            $statlabel = [
                '0' => ['class' => 'badge rounded-pill bg-label-info', 'text' => lang('app.baru')],
                '1' => ['class' => 'badge rounded-pill bg-label-dark', 'text' => lang('app.sudah pakai')],
            ];
        } else if ($asal == 'main') {
            $nomor = ($nomor[2] == '0' ? '0' : ($nomor[1] == '1' ? '1' : ($nomor[1] == 'a' ? '2' : '3')));
            $statlabel = [
                '0' => ['class' => 'badge rounded-pill bg-label-dark', 'text' => lang('app.inaktif')],
                '1' => ['class' => 'badge rounded-pill bg-label-primary', 'text' => lang('app.confirm')],
                '2' => ['class' => 'badge rounded-pill bg-label-info', 'text' => lang('app.baru')],
                '3' => ['class' => 'badge rounded-pill bg-label-warning', 'text' => lang('app.tunda')],
            ];
