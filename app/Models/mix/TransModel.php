...
class TransModel
{
    ...
    // // // //     $builder->update();
    // // // // }
    public function getDocumentNumber($table, $start, $year)
    {
        $builder = $this->db->table($table);
        $builder->like('document_number', $start, 'after')->like('document_number', $year);
        $builder->orderby('right(document_number,4) DESC');
        $builder->limit(1);
    ...
    //     return $builder->get()->getResult();
    // }
    public function cekBudgetChild($parent, $field, $data)
    {
