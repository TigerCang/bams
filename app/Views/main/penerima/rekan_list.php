                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-8 d-flex justify-content-between align-items-center mb-4">
                        <div class="form-floating form-floating-outline w-100 me-4">
                            <select class="select2-subtext form-select" id="spenerima" name="spenerima" data-allow-clear="true" data-placeholder="<?= lang('app.pilih-') ?>">
                                <?php if ($penerima1) : ?> <option value="<?= $penerima1[0]->id ?>" selected data-subtext="<?= $penerima1[0]->nama ?>"><?= $penerima1[0]->kode ?></option><?php endif ?>
                            </select>
                            <label for="spenerima"><?= lang('app.subkon') ?></label>
                        </div>
                        <div>
