        ...
        <div class="card mb-6">
            <div class="card-body">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-12 col-md-4 col-lg-4 mb-2">
                        <div class="form-floating form-floating-outline">
                            <select class="select2-non form-select" id="object" name="object" <?= (isset($budget[0]->status[0]) && $budget[0]->status[0] >= '1' ? 'disabled' : '') ?>>
                    ...
                    <div class="col-12 col-md-6 col-lg-6 mb-2">
                        <div class="form-floating form-floating-outline">
                            <select class="select2-subtext form-select" id="company" name="company" <?= (isset($budget[0]->status[0]) && $budget[0]->status[0] >= '1' ? 'disabled' : '') ?>>
                    ...
                    <div class="col-12 col-md-3 col-lg-3 mb-2">
                        <div class="form-floating form-floating-outline">
                            <select class="select2-non form-select" id="region" name="region" <?= (isset($budget[0]->status[0]) && $budget[0]->status[0] >= '1' ? 'disabled' : '') ?>>
                    ...
                    <div class="col-12 col-md-3 col-lg-3 mb-2">
                        <div class="form-floating form-floating-outline">
                            <select class="select2-non form-select" id="division" name="division" <?= (isset($budget[0]->status[0]) && $budget[0]->status[0] >= '1' ? 'disabled' : '') ?>>
                    ...
                    <div class="col-12 mb-2">
                        <div class="form-floating form-floating-outline">
                            <select class="select2-subtext form-select" id="branch" name="branch" <?= (isset($budget[0]->status[0]) && $budget[0]->status[0] >= '1' ? 'disabled' : '') ?> data-allow-clear="true" data-placeholder="<?= lang('app.selectSearch') ?>">
                                <?php if ($object1) : ?>
