    ...
    $('.btn-submit').click(function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                $('#qualificationAttachment, #registrationNumber, #titleAttachment, #descriptionAttachment, #startDate, #attachment').removeClass('is-invalid');
                $('.err_qualificationAttachment, .err_registrationNumber, .err_titleAttachment, .err_descriptionAttachment, .err_startDate, .err_attachment').html('');
                if (response.error) {
