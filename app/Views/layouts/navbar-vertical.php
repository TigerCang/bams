<nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme" id="layout-navbar">
    ...
    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
            ...
            <!-- Screen -->
            <li class="nav-item dropdown-language dropdown me-1 me-xl-0">
                <a class="nav-link btn btn-text-secondary rounded-pill btn-icon dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown" data-toggle="tooltip" title="<?= lang('app.layar') ?>">
                    <i class="ri-expand-diagonal-line ri-22px"></i>
                </a>
            </li>
            <!-- Pintasan  -->
            <li class="nav-item dropdown-shortcuts navbar-dropdown dropdown me-1 me-xl-0">
                <a class="nav-link btn btn-text-secondary rounded-pill btn-icon dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false" data-toggle="tooltip" title="<?= lang('app.pintasan') ?>">
                    <i class="ri-star-smile-line ri-22px"></i>
                </a>
                <div class="dropdown-menu dropdown-menu-end py-0">
                    <div class="dropdown-menu-header border-bottom">
                        <div class="dropdown-header d-flex align-items-center py-3">
                            <h5 class="text-body mb-0 me-auto"><?= lang('app.pintasan') ?></h5>
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        <img src="<?= base_url('assets/gambar/user/' . session()->avatar) ?>" alt class="rounded-circle" />
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="pages-account-settings-account.html">
                            <div class="d-flex">
                                ...
                                <div class="w-100">
                                    ...
                                    <small class="text-muted"><?= session()->usernama ?></small>
                                </div>
                            </div>
                        </a>
                    </li>
                    ...
                    <li>
                        <a class="dropdown-item" href="pages-profile-user.html">
                            ...
                            <span class="align-middle"><?= lang('app.profil') ?></span>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="pages-account-settings-account.html">
                            <i class="ri-layout-3-line ri-22px me-3"></i>
                            <span class="align-middle"><?= lang('app.tampilan') ?></span>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="pages-account-settings-account.html">
                            <i class="ri-rotate-lock-line ri-22px me-3"></i>
                            <span class="align-middle"><?= lang('app.sandi') ?></span>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="pages-account-settings-account.html">
                            <i class="ri-pulse-line ri-22px me-3"></i>
                            <span class="align-middle"><?= lang('app.aktifitas log') ?></span>
                        </a>
                    </li>
                    <li>
                        <div class="dropdown-divider"></div>
                    ...
                    <li>
                        <div class="d-grid px-4 pt-2 pb-1">
                            <a class="<?= json('btn signout') ?> d-flex" href="/logout">
                                <small class="align-middle"><?= lang('app.btn signout') ?></small>
                            </a>
                        </div>
                    </li>
                </ul>
