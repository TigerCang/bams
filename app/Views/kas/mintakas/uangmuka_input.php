...
<div class="row">
    <div class="col-12 col-md-12 col-lg-4">
        <div class="card mb-6">
            <div class="card-body">
                <input type="hiddena" id="idunik" name="idunik" value="<?= $idunik ?>" />
                <input type="hiddena" id="xkui" name="xkui">
                <input type="hiddena" id="xbeban" name="xbeban">
            ...
            <div class="card-body">
                ...
                <div class="row g-2">
                    <div class="col-12 col-md-4 col-lg-3 mb-4">
                        <div class="form-floating form-floating-outline">
                            <input type="text" readonly class="form-control" id="kodebeban" name="kodebeban" placeholder="<?= lang('app.harus') ?>" value="ABCDEFGHJK" />
        ...
        <div class="card mb-6">
            <div class="card-body">
                ...
                <div class="row g-2">
                    <div class="col-12 col-md-4 col-lg-4 mb-4">
                        <div class="form-floating form-floating-outline">
                            <input type="text" class="form-control autonumber" data-digit-after-decimal="4" data-a-sep="." data-a-dec="," id="jumlah" name="jumlah" placeholder="" value="<?= $kasanak[0]->jumlah ?? '0' ?>" onchange="hitungTotal()" />
                            <label for="jumlah"><?= lang('app.jumlah') ?></label>
                        </div>
                    </div>
                    <div class="col-12 col-md-4 col-lg-4 mb-4">
                        <div class="form-floating form-floating-outline">
                            <input type="text" class="form-control autonumber" data-digit-after-decimal="2" data-a-sep="." data-a-dec="," id="harga" name="harga" placeholder="" value="<?= $kasanak[0]->harga ?? '0' ?>" onchange="hitungTotal()" />
