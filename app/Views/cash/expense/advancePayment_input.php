    ...
    <div class="col-12 col-md-12 col-lg-6">
        <div class="card mb-6">
            <div class="card-body">
                ...
                <input type="hiddena" id="xAlias" name="xAlias" value="<?= ($cash[0]->role_as ?? 'branch') ?>" />
                <div class="row g-2">
                    <div class="col-12 col-md-8 col-lg-8 mb-2">
                        <div class="form-floating form-floating-outline">
                            <select class="select2-non form-select" id="requester" name="requester" <?= (isset($cash[0]->status) && $cash[0]->status >= '1' ? 'disabled' : '') ?>>
                    ...
                    <div class="col-12 mb-2">
                        <div class="form-floating form-floating-outline">
                            <select class="select2-non form-select" id="person" name="person" <?= (isset($cash[0]->status) && $cash[0]->status >= '1' ? 'disabled' : '') ?> data-allow-clear="true" data-placeholder="<?= lang('app.selectSearch') ?>" onchange="clickPerson()"></select>
        ...
        <div class="card mb-6">
            <div class="card-body">
                <div class="row g-2">
                    <div class="col-12 col-md-8 col-lg-8 mb-2">
                        <div class="form-floating form-floating-outline">
                            <select class="select2-non form-select" id="account" name="account" data-allow-clear="true" data-placeholder="<?= lang('app.select-') ?>"></select>
