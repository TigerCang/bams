    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header <?= lang('app.bgMinput') ?>">
                <h4 class="modal-title"><?= lang('app.titlekonfigurasi') ?></h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>

            <?= form_open_multipart('', ['class' => 'formkonfigurasi']) ?>
            <?= csrf_field() ?>
                    ...
                    <div class="col-sm-12">
                        <div class="card-block">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" readonly class="form-control" id="parameter" name="parameter" value="<?= lang('app.' . $konfigurasi[0]->parameter) ?>" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" <?= ($konfigurasi[0]->mode == 'B' ? '' : 'hidden') ?>>
                                ...
                                <div class="col-sm-4">
                                    <input type="nama" class="form-control" id="nama" name="nama" value="<?= $konfigurasi[0]->nilai ?>" autocomplete="off">
                                    <div class="invalid-feedback errnama"></div>
                                </div>
                            </div>
                        </div>
                        <!--  -->
                        <div class="modal-footer"><?= "<button type='submit' class='btn " . lang('app.btnOk') . " btnok'>" . lang('app.btn_Ok') . "</button>"; ?></div>
                    </div>
                </div>
            </div>
            <?= form_close() ?>
