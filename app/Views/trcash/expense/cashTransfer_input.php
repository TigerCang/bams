                ...
                <div class="row g-2">
                    ...
                    <div class="col-12 mb-2">
                        <div class="form-floating form-floating-outline">
                            ...
                            <select class="select2-subtext form-select" id="person" name="person" <?= (isset($cash[0]->status) && $cash[0]->status >= '1' ? 'disabled' : '') ?> data-placeholder="<?= lang('app.select-') ?>" onchange="clickPerson()">
            ...
            <div class="card-body">
                <div class="row g-2">
                    <div class="col-12 col-md-8 col-lg-8 mb-2">
                        <div class="form-floating form-floating-outline">
                            <!-- data-allow-clear="true" -->
                            <select class="select2-subtext form-select" id="account" name="account" <?= (isset($cash[0]->status) && $cash[0]->status >= '1' ? 'disabled' : '') ?> data-placeholder="<?= lang('app.select-') ?>">
                                <?php foreach ($selectAccount as $db) : ?>
                                    <option value="<?= $db->accountID ?>" <?= (isset($cash[0]) && $cash[0]->account_id == $db->accountID ? 'selected' : '') ?> data-subtext="<?= $db->accountName ?>"><?= $db->groupName . ' -> ' . $db->accountCode ?></option>
                                <?php endforeach ?>
                            </select>
