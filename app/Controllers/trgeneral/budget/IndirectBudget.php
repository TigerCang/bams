    ...
    public function addData()
    {
        if ($this->request->isAJAX()) {
            ...
            if (!$this->validate($validationRules)) {
                ...
                $cekLevel3 = $this->transModel->cekBudgetChild($parent[0]->id, 'cost_id', $db4[0]->idLevel3);
                if ($cekLevel3) {
                    $total3 = $this->transModel->getBudgetTotal($parent[0]->id, $db4[0]->idLevel3, 'cost');
                ...
                $cekLevel2 = $this->transModel->cekBudgetChild($parent[0]->id, 'cost_id', $db4[0]->idLevel2);
                if ($cekLevel2) {
                    $total2 = $this->transModel->getBudgetTotal($parent[0]->id, $db4[0]->idLevel2, 'cost');
                ...
                $cekLevel1 = $this->transModel->cekBudgetChild($parent[0]->id, 'cost_id', $db4[0]->idLevel1);
                if ($cekLevel1) {
                    $total1 = $this->transModel->getBudgetTotal($parent[0]->id, $db4[0]->idLevel1, 'cost');
            ...
            if (!$this->validate($validationRules)) {
                ...
                if ($this->request->getVar('postAction') == 'save') {
                    ...
                    $this->budgetparentModel->save([
                        ...
                        'date_end' =>  $this->request->getVar('endDate'),
                        'revision' => $revision,
                        'level_start' => $this->user['act_approve'],
                        'level_now' => $this->user['act_approve'],
                        'status' => '1', // save
