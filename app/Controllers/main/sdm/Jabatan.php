...
class Jabatan extends BaseController
{
    ...
    public function index()
    {
        checkPage('102');
        $data = [
            't_judul' => lang('app.jabatan golongan'),
            't_span' => lang('app.span jabatan golongan'),
            'link' => '/jabatan',
            'ihid' => 'hidden',
            'divisi' => $this->mainModel->getBerkas($this->urls[1], 'jabatan'),
            'wilayah' => $this->mainModel->getBerkas($this->urls[1], 'golongan'),
        ];
    ...
    public function inputData()
    {
        if ($this->request->isAJAX()) {
            ...
            $data = [
                't_modal' => lang('app.jabatan golongan'),
                'link' => "/jabatan",
                'ihid' => 'hidden',
                'berkas' => $db1,
                'tuser' => $this->user,
