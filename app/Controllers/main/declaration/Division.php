    ...
    public function saveData()
    {
        if ($this->request->isAJAX()) {
            ...
            if ($this->request->getVar('postAction') == 'delete') {
                ...
                if ($ruleLink !== 'required') cekLink('m_tool', $field, $db1[0]->id, $ruleLink);
                if ($ruleLink !== 'required') cekLink('m_land', $field, $db1[0]->id, $ruleLink);
            ...
            if (!$this->validate($validationRules)) {
                ...
                if ($this->request->getVar('postAction') == 'save') {
                    ...
                    $this->fileModel->save([
                        ...
                        'name2' => strtoupper($this->request->getVar('initial')),
