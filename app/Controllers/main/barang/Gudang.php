...
class Gudang extends BaseController
{
    ...
    public function index()
    {
        checkPage('102');
        $data = [
            't_judul' => lang('app.gudang'),
            't_span' => lang('app.span gudang'),
            'link' => '/gudang',
            'satuan' => $this->mainModel->getBerkas($this->urls[1], 'gudang'),
            'chid' => 'hidden',
            'ghid' => ''
        ];
    ...
    public function saveData()
    {
        if ($this->request->isAJAX()) {
            ...
            $nama = $this->mainModel->cekBerkas('gudang', 'nama', $this->request->getVar('deskripsi'), $this->request->getVar('idunik'));
